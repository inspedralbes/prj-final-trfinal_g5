  ...
  export default {
    data() {
      return {
        ...
        dietas: [],
        dietas2: [],
        ultimaActualizacion: null, // Nueva variable para manejar la última actualización
      };
    },
    methods: {
      async enviarMensaje() {
        try {
          ...
          if (this.imagenSeleccionada) {
            data.imagen_base64 = this.imagenSeleccionada.split(',')[1];
          }
    ...
    async mounted() {
      ...
      await this.mostrarMensajes();
      this.interval = setInterval(this.mostrarMensajes, 5000); // Cambio de intervalo a 5000 ms (5 segundos)
    },
